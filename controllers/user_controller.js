...
exports.edit = function(req, res) {
  res.render('user/edit', { user: req.user, title:'editar', errors: []});
...
exports.new = function(req, res) {
    ...
    res.render('user/new', {user: user, title: 'nuevo usuario', errors: []});
};
...
exports.create = function(req, res) {
    ...
    .then(
        function(err){
            if (err) {
                res.render('user/new', {user: user, title: 'Error', errors: err.errors});
            } else {
...
exports.update = function(req, res, next) {
  ...
  .then(
    function(err){
      if (err) {
        res.render('user/' + req.user.id, {user: req.user, title: 'Error', errors: err.errors});
      } else {
